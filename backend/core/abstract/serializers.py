...
class AbstractSerializer(serializers.ModelSerializer): #serializers.ModelSerializer is a Django REST Framework class that auto-generates serializer fields from a model — simplifying conversion between model instances and JSON.
